...
$LC4:
	...
	.align	2
$LC5:
	.ascii	"123456789012345678901234567890123456789012\000"
	.rdata
	.align	2
$LC6:
	.word	$LC0
...
$LFB2:
	.file 20 "strlen.c"
	.loc 20 24 0
	.frame	$sp,72,$31		# vars= 24, regs= 7/0, args= 16, gp= 0
	.mask	0x803f0000,-8
	.fmask	0x00000000,0
	.set	noreorder
	.set	nomacro
...
$LCFI7:
	.loc 20 25 0
	addiu	$2,$3,%lo($LC6)	 # tmp185, tmp182,
	lw	$4,%lo($LC6)($3)	 # tmp183,
	lw	$8,20($2)	 # tmp192,
	lw	$5,4($2)	 # tmp184,
	lw	$3,8($2)	 # tmp186,
	lw	$6,12($2)	 # tmp188,
	lw	$7,16($2)	 # tmp190,
	sw	$4,16($sp)	 # tmp183, msgs
	sw	$5,20($sp)	 # tmp184, msgs
	sw	$3,24($sp)	 # tmp186, msgs
	sw	$6,28($sp)	 # tmp188, msgs
	sw	$7,32($sp)	 # tmp190, msgs
	sw	$8,36($sp)	 # tmp192, msgs
	lui	$21,%hi($LC7)	 # tmp217,
	li	$20,1			# 0x1	 # tmp218,
	addiu	$19,$sp,16	 # tmp225,,
	li	$18,5			# 0x5	 # i,
$L7:
$LBB2:
	.loc 20 38 0
	lw	$16,0($19)	 # tmp206, msgs
$LBE2:
	.loc 20 37 0
	addiu	$18,$18,-1	 # i, i,
$LBB3:
	...
	addiu	$19,$19,4	 # tmp225, tmp225,
	.loc 20 44 0
	li	$4,1			# 0x1	 #,
	addiu	$5,$21,%lo($LC7)	 #, tmp217,
	.loc 20 40 0
	bne	$2,$17,$L10	 #,, tmp207,
	li	$6,1			# 0x1	 #,
