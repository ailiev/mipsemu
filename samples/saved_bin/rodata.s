...
#NO_APP
	...
	.align	2
$LC0:
	.ascii	"the string constant goes into the rodata section. extra "
	.ascii	"char:\000"
	.align	2
$LC1:
	.ascii	"\n\000"
...
$LCFI1:
	.loc 17 23 0
	addiu	$9,$sp,16	 # tmp184,,
	addiu	$7,$6,48	 # tmp185, tmp183,
$L2:
	lw	$2,0($6)	 # tmp186,
	lw	$3,4($6)	 # tmp187,
	lw	$4,8($6)	 # tmp188,
	...
	sw	$4,8($9)	 # tmp188,
	sw	$5,12($9)	 # tmp189,
	bne	$6,$7,$L2	 #, tmp183, tmp185,
	addiu	$9,$9,16	 # tmp184, tmp184,
